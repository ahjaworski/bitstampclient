...
This will create an executable jar file **bitstampclient.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/bitstampclient.jar

To launch the test page, open your browser at the following URL

    http://localhost:8181/bitstampclient/index.html
